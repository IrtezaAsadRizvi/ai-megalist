...
FLUX is the model that quietly took the "best per dollar photoreal image gen" crown in 2024 and held it through the various Midjourney refreshes. It's developed by Black Forest Labs (a team that left Stability AI) and unlike Midjourney it has a real production API, which is why most apps that need image gen at scale point at FLUX.
